...
fn main(){
	...
	let mut material2 = SharedMaterials::new(material2);

	let normal_mat = SharedMaterials::new(Material::new_normal());
	...
	let mut boxMat = SharedMaterials::new(material_sphere);
