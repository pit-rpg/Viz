...
use project::{
	core::{
		create_world, BufferType, Material, PerspectiveCamera, PointLight,
	...
	helpers::{geometry_generators, load_obj, Nums},
...
fn main() {
	...
	let shared_test_mat = SharedMaterials::new(test_mat);
	...
	for _ in 0..lights_count {
		...
		let material_light = SharedMaterials::new(Material::new_basic(Vector4::new(
